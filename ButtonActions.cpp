...
void ButtonActions::update_keybind(int buttonId, 
	void(*new_action)(sf::RenderWindow & app))
{
...
// update keybind from menu
void ButtonActions::update_keybind_event(int buttonId, 
	void(*new_action)(sf::Event &e))
{
